...
const CategoriaApp = () => {
  ...
  const agregarCategoria = async () => {
    ...
    try {
      await axios.post("https://backend-carniceria-la-bendicion-production.up.railway.app/categoria/agregar", {
  ...
  const actualizarCategoria = async () => {
    ...
    try {
      ...
      await axios.put("https://backend-carniceria-la-bendicion-production.up.railway.app/categoria/actualizar", {
  ...
  const eliminarCategoria = async (id) => {
    try {
      ...
      await axios.delete(`https://backend-carniceria-la-bendicion-production.up.railway.app/categoria/eliminar/${id}`);
  ...
  const activarDesactivarCategoria = async (id) => {
    try {
      await axios.put(`https://backend-carniceria-la-bendicion-production.up.railway.app/categoria/activar/${id}`);
