...
const ComentarioApp = () => {
  ...
  const cargarComentarios = async () => {
    try {
      const response = await axios.get(
        "https://backend-carniceria-la-bendicion-production.up.railway.app/comentario/admin"
      );
  ...
  const cargarUsuario = async (id) => {
    try {
      const response = await axios.get(
        `https://backend-carniceria-la-bendicion-production.up.railway.app/usuario/obtenerPorId/${id}`
      );
  ...
  const agregarComentario = async () => {
    ...
    try {
      ...
      await axios.post(
        "https://backend-carniceria-la-bendicion-production.up.railway.app/comentario/agregar",
        comentarioData
      );
  ...
  const actualizarComentario = async () => {
    ...
    try {
      await axios.put("https://backend-carniceria-la-bendicion-production.up.railway.app/comentario/actualizar", {
  ...
  const verificacionEstado = async (id) => {
    try {
      await axios.put(`https://backend-carniceria-la-bendicion-production.up.railway.app/comentario/verificar/${id}`);
  ...
  const activarComentario = async (id) => {
    try {
      await axios.delete(`https://backend-carniceria-la-bendicion-production.up.railway.app/comentario/activar/${id}`);
