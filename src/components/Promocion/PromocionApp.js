...
const PromocionApp = () => {
  ...
  const cargarPromociones = async () => {
    try {
      const response = await axios.get("https://backend-carniceria-la-bendicion-production.up.railway.app/promocion/");
  ...
  const agregarPromocion = async () => {
    ...
    try {
      await axios.post("https://backend-carniceria-la-bendicion-production.up.railway.app/promocion/agregarPromocion", promocionData);
  ...
  const actualizarPromocion = async () => {
    ...
    try {
      console.log("Datos enviados al backend:", promocionData);
      await axios.put("https://backend-carniceria-la-bendicion-production.up.railway.app/promocion/actualizar", promocionData);
  ...
  const eliminarPromocion = async (id) => {
    ...
    try {
      await axios.delete(`https://backend-carniceria-la-bendicion-production.up.railway.app/promocion/eliminar/${id}`);
  ...
  const enviarMensaje = async (promocion) => {
    ...
    try {
      ...
      const response = await axios.post(`https://backend-carniceria-la-bendicion-production.up.railway.app/promocion/mensaje?nombreProducto=${encodeURIComponent(promocion.nombreProducto)}`, promocion);
  ...
  const activarDesactivarPromocion = async (id) => {
    ...
    try {
      await axios.put(`https://backend-carniceria-la-bendicion-production.up.railway.app/promocion/activar/${id}`);
